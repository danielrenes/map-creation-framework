...
class Feeder:
    def __init__(self, mapping: Mapping[str, str], queue: 'Queue'):
...
class CsvFeeder(Feeder):
    def __init__(self, mapping: Mapping[str, str], queue: 'Queue', f: TextIO, delimiter: str):
        super().__init__(mapping, queue)
...
class SumoFeeder(Feeder):
    def __init__(self, mapping: Mapping[str, str], queue: 'Queue', sumocfg_path: str):
        super().__init__(mapping, queue)
